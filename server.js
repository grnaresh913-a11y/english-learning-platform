  ...
  if (existing.rows[0].n === 0) {
    ...
    for (const lesson of LESSONS) {
      ...
      for (const ex of (lesson.exercises || [])) {
        await pool.query(
          `INSERT INTO exercises (concept_id, position, type, question, options, answer, explanation)
           VALUES ($1, $2, $3, $4, $5, $6, $7)`,
          [conceptId, pos++, ex.type, ex.question,
      ...
      for (const v of (lesson.vocabulary || [])) {
        await pool.query(
          `INSERT INTO vocabulary (concept_id, word, meaning, example, level, module)
           VALUES ($1, $2, $3, $4, $5, $6)`,
          [conceptId, v.word, v.meaning, v.example, lesson.level, lesson.module]
        );
        vocabCount++;
      }
    }
...
async function startServer() {
  ...
  try {
    ...
    console.error('FATAL: database setup failed:', error.message);
    process.exit(1);
  }
